...
def monitor_system():
    print(f"{'Time':<8} {'CPU %':<7} {'RAM %':<7} {'CPU °C':<8} {'GPU °C':<8} {'Freq':<12} {'Power Status':<25} {'Status'}")
    print("-" * 110)
    while True:
        ...
        print(f"{current_time:<8} {cpu_percent:<7} {ram_percent:<7} {cpu_temp:<8} {gpu_temp:<8} {cpu_freq:<12} {power_status:<25} {temp_status}")
        time.sleep(1)
